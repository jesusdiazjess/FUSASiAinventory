...
while ($orderResult = $orderQuery->fetch_assoc()) {
    ...
    if (is_numeric($paid)) { // Check if it's numeric
        $totalRevenue += (float)$paid; // Convert to float to avoid issues with types
    }
}
...
<div class="row">
	...
	<div class="col-md-4">
		...
		<div class="card">
		  ...
		  <div class="cardContainer">
		    <p> Total Revenue as of Today in ₱</p>
		  </div>
		</div> 
	...
	<div class="col-md-8">
		<div class="panel panel-default">
			<div class="panel-heading"> <i class="glyphicon glyphicon-calendar"></i> EMPLOYEE DASHBOARD</div>
			<div class="panel-body">
				<table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			<th style="width:40%;">Name</th>
			  			<th style="width:20%;">Orders in Philippine Peso</th>
			  		</tr>
			  	</thead>
			  	<tbody>
